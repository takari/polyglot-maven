open class Dependencies: DependenciesUnderTheHood() {
    ...
    fun import(groupId: String, artifactId: String, version: String, optional: Boolean = false, classifier: String? = null)
            = dependencyOn(groupId, artifactId, version, "import", "pom", classifier, null, optional)
    ...
    fun import(vararg artifacts: String) = dependenciesOn(artifacts, "import")
    ...
    fun import(artifact: String) = dependencyOn(artifact, "import")
